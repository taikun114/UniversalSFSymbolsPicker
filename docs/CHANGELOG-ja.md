...
#### 新機能
- **SF Symbols 8に対応**
- **生成AIによるルーマニア語（`ro`）のローカライズを追加**

#### バグ修正と改善
- **iOS / iPadOSのシートがダークモード時にわずかにグリーンに見える問題を修正**
- **macOS Golden Gateでシート表示時にカテゴリピッカーラベルが表示されなかった問題を修正**
- **watchOSでカテゴリピッカーに正しいアイコンが表示されなかった問題を修正**
- **バージョン26以降で検索欄の見た目を改善**
- **iOS / iPadOS 27およびmacOS Golden Gateのスクロールエッジエフェクトを改善**
  - OS側の修正により正しく表示されるようになったため、`.soft`スタイルに戻しました。
- **フランス語（`fr`, `fr-CA`）のカテゴリ名ローカライズを公式に合わせて更新**
